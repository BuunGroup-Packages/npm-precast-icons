<template>
  <div class="icon-showcase">
    <h1>Precast Icons - Vue Examples</h1>
    <p class="subtitle">Comprehensive showcase of icon usage patterns in Vue applications</p>
    ...
    <section>
      ...
      <div class="icon-row size-demo">
        <div class="icon-wrapper">
          <SearchIcon :size="32" :stroke-width="0.5" />
          <span>0.5</span>
        </div>
        <div class="icon-wrapper">
          <SearchIcon :size="32" :stroke-width="1" />
          <span>1</span>
        </div>
        <div class="icon-wrapper">
          <SearchIcon :size="32" :stroke-width="2" />
          <span>2 (default)</span>
        </div>
        <div class="icon-wrapper">
          <SearchIcon :size="32" :stroke-width="3" />
          <span>3</span>
        </div>
        <div class="icon-wrapper">
          <SearchIcon :size="32" :stroke-width="4" />
          <span>4</span>
        </div>
      </div>
    </section>
    ...
    <section>
      <h2>Fill and Stroke Combinations</h2>
      <div class="icon-row">
        <HeartIcon :size="32" fill="pink" stroke="red" :stroke-width="2" />
        <StarIcon :size="32" fill="yellow" stroke="orange" :stroke-width="2" />
        <UserIcon :size="32" fill="lightblue" stroke="navy" :stroke-width="2" />
    ...
    <section>
      ...
      <div class="dynamic-section">
        ...
        <div class="dynamic-icon-display">
          <component
            :is="dynamicIcon"
            :size="48"
            :color="dynamicColor"
        ...
        <div class="controls">
          ...
          <label>
            Stroke Width:
            <input type="range" v-model.number="strokeWidth" min="0.5" max="4" step="0.5" />
            {{ strokeWidth }}
          </label>
        </div>
      </div>
    ...
    <section>
      <h2>Form Input with Icons</h2>
      <div class="form-group">
        <div class="input-with-icon">
          <SearchIcon :size="20" class="input-icon" />
        ...
        <div class="input-with-icon">
          <HeartIcon :size="20" class="input-icon" />
...
const dynamicIcon = computed(() => iconMap[selectedIcon.value]);
</script>
