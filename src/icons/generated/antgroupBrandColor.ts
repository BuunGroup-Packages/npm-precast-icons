...
/**
 * AntgroupBrandColor icon definition
 */
export const antgroupBrandColor: IconDefinition = {
  "name": "antgroupBrandColor",
  "viewBox": "0 0 73 24",
  "content": [
    {
      "tag": "title",
    ...
    },
    {
      ...
      "attrs": {
        ...
        "fill": "url(#lobe-icons-ant-group-brand-fill-0)",
    ...
    },
    {
      ...
      "attrs": {
        ...
        "fill": "url(#lobe-icons-ant-group-brand-fill-1)",
        "transform": "translate(2)"
      },
      "children": []
    },
    {
      ...
      "attrs": {
        ...
        "fill": "url(#lobe-icons-ant-group-brand-fill-2)",
        "transform": "translate(2)"
      },
      "children": []
    },
      ...
      "children": [
        {
          "tag": "linearGradient",
          "attrs": {
            "id": "lobe-icons-ant-group-brand-fill-0",
            "x1": "32.052%",
            "x2": "60.95%",
            "y1": "95.551%",
            "y2": "-.348%"
        ...
        },
        {
          "tag": "linearGradient",
          "attrs": {
            "id": "lobe-icons-ant-group-brand-fill-1",
            "x1": "6.029%",
            "x2": "92.742%",
            "y1": "65.982%",
            "y2": "32.918%"
        ...
        },
        {
          "tag": "linearGradient",
          "attrs": {
            "id": "lobe-icons-ant-group-brand-fill-2",
            "x1": "56.027%",
            "x2": "46.133%",
            "y1": "99.257%",
            "y2": "1.384%"
